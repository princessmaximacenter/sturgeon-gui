...
public class Config {
    ...
    public void setCnvPlot(String cnvPlot) {
        this.cnvPlot = cnvPlot;
    }

    public String getConfidencePlot() {
        return confidencePlot;
    }

    public void setConfidencePlot(String confidencePlot) {
        this.confidencePlot = confidencePlot;
    }

    public String getPredictPlot() {
        return predictPlot;
    }

    public void setPredictPlot(String predictPlot) {
        this.predictPlot = predictPlot;
    }

    public String getConfidenceTable() {
